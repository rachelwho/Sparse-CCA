...
## Instruction
To reproduce the numerical results in the paper, you may find codes and instruction in each folder. Table 1 and Figure 1 is produced by the files in /continuous. Figure 2, Figure 3, Table 2 and Table 3 is produced by the files in /mixdata. Figure 4 is produced by the files in /covid. We also investigate the results for estimating the mixing time of our algorithm produced by the files in /mixingtime and estimating the sample size condition for our algorithm produced by the files in /sample_size. Those results can be found in the supplementary materials.
